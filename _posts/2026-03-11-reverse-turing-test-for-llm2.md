...
测量结果是一个具体的本征值 $a_k$，其出现的概率为 $\left| a_k \right|^2$，由测量前的叠加系数决定。

若 $\left| a_k \right|^2$ 较大，则该本征态在叠加中占主导地位，更可能被观测到；

若 $\left| a_k \right|^2$ 较小，则该本征态占比低，几乎不会被测到。



测量结果是一个具体的本征值 $a_k$，其出现的概率为 $\lvert a_k \rvert^2$，由测量前的叠加系数决定。

若 $\lvert a_k \rvert^2$ 较大，则该本征态在叠加中占主导地位，更可能被观测到；

若 $\lvert a_k \rvert^2$ 较小，则该本征态占比低，几乎不会被测到。
